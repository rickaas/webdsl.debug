...
public class FunctionEnterExitTests extends EventInstrumentationBase {
	...
	public void setupProgram() throws ParseError, IOException {
		initHI();
		loadDSLDI(WebdslTestConstants.WEBDSL_SCRIPTS_DIR + "/dsldis/FunctionEnterExit.dsldi");
	...
	public void instrumentGlobalScript() {
		...
		compareDslProgramSourceWithReferenceFile(this.getInstrumentedLocation() + ".enter-exit.app");
	}
