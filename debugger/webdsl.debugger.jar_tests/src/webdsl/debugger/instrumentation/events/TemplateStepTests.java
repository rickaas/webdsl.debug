...
public class TemplateStepTests extends EventInstrumentationBase {
	...
	public void setupProgram() throws ParseError, IOException {
		initHI();
		loadDSLDI(WebdslTestConstants.WEBDSL_SCRIPTS_DIR + "/dsldis/TemplateStep.dsldi");
...
//	}
	...
	@Test
	public void instrumentMakeUsersScript() {
		...
		Assert.assertTrue(new File(this.getGeneratedLocation()).exists());
		compareDslProgramSourceWithReferenceFile(this.getInstrumentedLocation() + ".template.step.app");
	}
