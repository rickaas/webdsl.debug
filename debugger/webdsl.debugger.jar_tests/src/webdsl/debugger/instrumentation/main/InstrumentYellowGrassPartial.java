...
public class InstrumentYellowGrassPartial extends EventInstrumentationBase {
	...
	/**
	 * Instrument a subset of the YellowGrass application, useful to determine to deduce which file is causing problems during instrumentation.
	 */
	//@Test
	@Ignore
	public void instrumentYellowGrass_PartialScript() {
		this.initHI();
		...
		sourceAppDirectory = WebdslTestConstants.WEBDSL_SCRIPTS_TESTCASES_DIR + "/programs/yg_partial";
		...
		//Assert.assertEquals(8, instrumentedFiles.size());
