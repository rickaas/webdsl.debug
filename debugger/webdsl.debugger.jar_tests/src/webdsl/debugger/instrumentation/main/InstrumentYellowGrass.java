...
public class InstrumentYellowGrass extends EventInstrumentationBase {

	private String sourceAppDirectory = null;
	
	private String target = "/home/rlindeman/Applications/development/eclipse/spoofax-installs/webdsl-language-modifications/workspace/webdsl-apps/yellowgrass-di/yellowgrass";
	...
	@Test
	public void instrumentYellowGrass_MainScript() {
		this.initHI();
		...
		sourceAppDirectory = WebdslTestConstants.WEBDSL_SCRIPTS_TESTCASES_DIR + "/programs/yellowgrass";
		...
		Assert.assertEquals(73, instrumentedFiles.size());
